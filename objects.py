...
class Skills(object):
    def __init__(self, skillname = None):
        self.skillname = skillname

    def __repr__(self):
        return "{skillname}".format(skillname = self.skillname)

class Interests(object):
    def __init__(self, interestname = None):
        self.interestname = interestname

    def __repr__(self):
        return "{interestname}".format(interestname = self.interestname)
